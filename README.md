...
| [playbooks/dockhand-adopt.yml](playbooks/dockhand-adopt.yml) | — (Dockhand API via the panel; registers the Ansible-deployed Hawser stack so it is not "Untracked" — registers only, never deploys) | `dockhand_adopt_target` (default: controller) |
