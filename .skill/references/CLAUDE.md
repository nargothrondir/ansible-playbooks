...
| File | When to read |
|---|---|
| [workflow.md](workflow.md) | Drafting an action plan for a large or ambiguous change; assumption categorization; the dependency-impact report format |
| [ansible-standards.md](ansible-standards.md) | The worked ✅/❌ examples behind §6–§8 and the rationale for the conventions |
