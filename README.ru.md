...
| [playbooks/provision-node.yml](playbooks/provision-node.yml) | bootstrap, upgrade, debian_release, ssh_hardening, common, dns, netbird, docker, xanmod, hawser, crowdsec, ufw, beszel_agent + API панели | (survey) |
...
| [playbooks/openbao-backup.yml](playbooks/openbao-backup.yml) | — (raft-снапшот в Telegram, ежедневно из Semaphore; доказывает отправку, не восстановление) | controller |
